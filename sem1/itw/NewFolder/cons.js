...
var vm = function () {
    ...
    self.displayName = 'Paris2024 National Olympic Committees List';
    ...
    self.activate = function (id) {
        ...
        var composedUri = self.baseUri() + "?page=" + id + "&pageSize=" + self.pagesize() + "&order=" + self.sortMode() + "&search=" + self.searchQ();
        ajaxHelper(composedUri, 'GET').done(function (data) {
            console.log(data);
            hideLoading();
            self.cons(data.NOCs);
            ...
            console.log("Total cons:", data.TotalNOCs);
        });
    }
