...
Entidades: Produto, Armazém, Encomenda, Fornecedor, Item, Taxa de Iva, Condição de pagamento.
Atributos: Nome, Preço, Número de produtos, Número de encomenda, Data, NIF, Endereço, Email, Código de tipo de fornecedor.
Relações: Armazém-Produto, Produto-Item, Produto-Taxa de Iva, Item-Encomenda, Encomenda-Fornecedor, Fornecedor-Condição de Pagamento.
...
```
Neste caso, todas as relações são binárias, de cardinalidade 1:N, e obrigatórias.
...
![ex_2_1!](2_1.png "AnImage or PDF file")!
...
![ex_2_2!](2_2.png "AnImage or PDF file")
...
![ex_2_3!](2_3.png "AnImage or PDF file")
...
![ex_2_4a!](2_4a.png "AnImage or PDF file")
...
![ex_2_4b!](2.4_final.png "AnImage or PDF file")
